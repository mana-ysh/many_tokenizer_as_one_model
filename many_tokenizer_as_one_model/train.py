...
from many_tokenizer_as_one_model.multi_criterion_dataset_reader import MultiCriterionDatasetReader
from many_tokenizer_as_one_model.multi_criterion_tokenizer import MultiCriterionTokenizer


def build_dataset_reader() -> DatasetReader:
    return MultiCriterionDatasetReader()
...
def read_data(
    ...
    validation_data = reader.read("./data/sample/train_dataset.json")  # TODO: same data
...
def build_model(vocab: Vocabulary) -> Model:
    ...
    return MultiCriterionTokenizer(word_embeddings, criterion_embedding, lstm, vocab)
